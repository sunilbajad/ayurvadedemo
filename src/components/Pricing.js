                    ...
                    <button
                      className={`${
                        index === currentIndex
                          ? ' bg-green text-white'
                          : ' border-green'
                      } w-full h-[50px] rounded border border-green-400 flex items-center justify-center text-green-400 font-medium transition relative`}
                    >
                      {buttonText}
                      <div
                        className={`${
                          index === currentIndex ? 'bg-green-200' : 'bg-green-400'
