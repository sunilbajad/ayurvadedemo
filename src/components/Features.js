      ...
      <div className='container mx-auto'>
        ...
        >
          <div
            ...
            className='text-6xl lg:text-[120px] text-Dark cursor-pointer hover:scale-110 transition'
          >
            <BsPlayCircleFill />
          </div>
        </div>
        <div className='flex flex-col lg:flex-row lg:gap-x-8'>
          <div className='flex-1' data-aos='fade-right'>
            ...
            <h2 className='h2 mb-3 lg:mb-0'>
              The Better Way to <br /> Start ayurveda
            </h2>
          </div>
          <div className='flex-1' data-aos='fade-left'>
            ...
            <button className='btn btn-sm btn-green hover:bg-green hover:text-white '>Get started</button>
          </div>
        </div>
      </div>
      <ModalVideo
